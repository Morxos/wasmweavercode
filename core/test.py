...
def main():
    ...
    for result in generate_code(64116-1, min_byte_code_size=0, max_byte_code_size=100, min_fuel=0,
                                max_fuel=100, verbose=True, selection_strategy=RandomSelectionStrategy(),output_types=[I32]):
