...
class AbstractPostProcessor:
    """
    Abstract post processor that can modify the global state after generation.
    """
...
class StackInspectorPostProcessor(AbstractPostProcessor):
    """
    Inserts a stack analysis tile at some random point in the program.
    """
...
class FlagReachabilityPostProcessor(AbstractPostProcessor):
    """
    Inserts reachability flag tiles at interesting points in the program.
    """
