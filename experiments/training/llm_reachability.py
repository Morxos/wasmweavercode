...
EXPERIMENT_NAME = "REACHABILITY_EXPERIMENT"
...
def main():
    ...
    env = gym.make("gymnasium_env/WasmWeaverEnv-v0",
                   ...
                   reward_function=SimpleRewardFunction(f"{EXPERIMENT_NAME}_samples", stack_reward=False, flag_reward=True, model=Gpt41()),
                   verbose=True)
